...
class StrakaBubblePlottingDataset(Dataset):
    def __init__(self, which="training", nf=0, training_samples = 750, s=512, in_dist = True, t_in=0, t_out=900):
...
class StrakaBubble:
    def __init__(self, network_properties, device, batch_size, training_samples, in_dist = True, t_in=0, t_out=900):
        ...
        num_workers = 0
        # for training on t=0 to t=tend
        self.train_loader = DataLoader(StrakaBubblePlottingDataset("training", training_samples), batch_size=batch_size, shuffle=True, num_workers=num_workers)
        self.val_loader = DataLoader(StrakaBubblePlottingDataset("validation", training_samples), batch_size=batch_size, shuffle=False, num_workers=num_workers)
        self.test_loader = DataLoader(StrakaBubblePlottingDataset("test", training_samples, in_dist), batch_size=batch_size, shuffle=False, num_workers=num_workers)
        
        # for training on a fixed dt
