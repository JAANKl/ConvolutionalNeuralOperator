...
def plot_comparison(true_fft, predicted_fft_cno, predicted_fft_fno, nx, nz):
    ...
    axs[1].set_title("FFT of Predicted Average Amplitude CNO", fontsize=20)
    ...
    axs[2].set_title("FFT of Predicted Average Amplitude FNO", fontsize=20)
...
# Load FNO model
model_fno_path = 'TrainedModels/FNO_straka_bubble_0_to_900_normalized_everywhere/model.pkl'
